...
CREATE TABLE grupo_permisao (
  grupo_id BIGINT NOT NULL REFERENCES permissao (id) ON UPDATE NO ACTION ON DELETE NO ACTION,
  permissao_id BIGINT NOT NULL REFERENCES grupo (id) ON UPDATE NO ACTION ON DELETE NO ACTION
);
